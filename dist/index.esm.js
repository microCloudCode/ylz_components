import React, { useRef, useState, useEffect, useMemo, useContext, memo, forwardRef, useImperativeHandle } from 'react';
...
var Foot = (function (_ref) {
  ...
  var _useContext = useContext(StencilContext),
      footUrl = _useContext.footUrl;
...
var StencilContext = React.createContext({
  coverUrl: "",
  footUrl: ""
});
/**
...
var Preview = memo(forwardRef(function (_ref, ref) {
  ...
  return React.createElement("div", {
    ...
    ref: divRef
  }, React.createElement(StencilContext.Provider, {
    value: {
      coverUrl: coverUrl,
      footUrl: footUrl
    }
